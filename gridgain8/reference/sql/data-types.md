---
description: >-
  Reference of the SQL data types available in GridGain — boolean, numeric,
  string, date/time, and binary types — and their language and driver mappings.
---
...
{% hint style="info" %}
Using CHAR type may produce results that contradict to CHAR handling described in ANSI SQL standard. Consider using VARCHAR instead.
{% endhint %}
...
{% hint style="info" %}
Use the [TIMESTAMP](#timestamp) type instead of DATE whenever possible. The DATE type is serialized/deserialized very inefficiently resulting in performance degradation.
{% endhint %}
