---
description: >-
  Reference of the SQL Data Manipulation Language (DML) commands supported by
  GridGain — SELECT, INSERT, UPDATE, WITH, MERGE, and DELETE.
---
...
{% hint style="warning" %}
You cannot execute DML commands during ongoing key-value transactions because such execution increases the risk of a deadlock.
{% endhint %}
...
`SELECT` queries can be executed against both [replicated](../../architecture/data-modeling/data-partitioning.md#replicated) and [partitioned](../../architecture/data-modeling/data-partitioning.md#partitioned) data.
