---
description: >-
  Explains how to use maintenance mode in MariaDB Enterprise to safely perform
  maintenance operations, including cordoning the cluster, draining connections,
  and setting the database to read-only.
---
...
{% hint style="info" %}
MaxScale also supports putting individual backend MariaDB servers in maintenance mode. See the [Server maintenance](topologies/maxscale.md#server-maintenance) section for details.
{% endhint %}
