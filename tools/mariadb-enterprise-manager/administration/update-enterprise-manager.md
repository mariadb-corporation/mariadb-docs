---
description: >-
  Instructions for updating an existing MariaDB Enterprise Manager deployment in
  place.
---
...
Insert your Customer Download Token into the download URL and download the latest installer in the the same folder where you have fol:
...
Update Enterprise Manager by running the script:
