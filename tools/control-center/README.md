...
GridGain Control Center is a management and monitoring tool for GridGain® clusters. It features a graphical user interface that helps you perform administrative tasks and monitor your clusters.
...
## Supported GridGain 8 Versions

You can use Control Center to monitor GridGain 8.9.0 or later.

The following features require a GridGain version later than 8.9.0:

| Feature | GridGain Version |
|---|---|
| Data center replication dashboards | 8.9.1+ |
| Scan queries | 8.9.1+ |
| Binary Type Management | 8.9.1+ |
