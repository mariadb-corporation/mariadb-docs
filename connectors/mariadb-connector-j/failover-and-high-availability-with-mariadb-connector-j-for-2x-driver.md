...
Without any query during the time defined by the validConnectionTimeout parameter (defaults to 0, i.e. disabled), and if not set to 0, a verification will be done that the replication role of the underlying connections hasn't changed.
