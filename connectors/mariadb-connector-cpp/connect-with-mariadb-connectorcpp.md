...
The compatibility syntax for connection URLs is only supported for the [sql::Driver::connect()](connect-with-mariadb-connectorcpp.md#sql-driver-connect) connection method.
...
* They can be specified in a [connection URL with JDBC syntax](connect-with-mariadb-connectorcpp.md#jdbc-syntax).
...
| user                     | Defines the user name of the user account to connect with.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |        |                 | • userName ([sql::Driver::connect()](connect-with-mariadb-connectorcpp.md#sql-driver-connect) connection method only) |
