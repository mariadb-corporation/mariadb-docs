---
description: >-
  Connect to a GridGain 9 cluster with the ODBC driver and run SQL to create
  tables, query, insert, update, and delete data.
---
...
```cpp
// Connecting to GridGain Cluster.
...
if (!SQL_SUCCEEDED(ret))
{
  ...
  std::cerr << "Failed to connect to GridGain: "
