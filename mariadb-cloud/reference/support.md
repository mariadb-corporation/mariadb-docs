...
Features and topologies released in [_Tech Preview_](../quickstart/enterprise-cluster.md) (such as MariaDB Enterprise Cluster) receive limited Problem Resolution Support. For these deployments, support is provided on a best-effort basis and they are excluded from standard Support SLAs.
{% endhint %}
