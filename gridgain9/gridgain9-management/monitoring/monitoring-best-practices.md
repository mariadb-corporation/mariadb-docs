...
For the full description of each metric, see [Available Metrics](../../reference/monitoring/metrics-list.md).
...
For the full list of partition states and recovery actions, see [Disaster Recovery](../disaster-recovery/data-recovery.md).
...
On Kubernetes, the operator wires the liveness and readiness endpoints as pod probes. See [Monitoring with the Kubernetes Operator](../../integrations/k8s-operator/monitoring.md).
...
* [System Views](../../reference/monitoring/system-views.md) — the full catalog of views used in [Diagnostics](#diagnostics).
