...
{% hint style="info" %}
Before deploying models, ensure you have configured GridGain ML thread pool settings. See the [Thread Pool Configuration](get-started-with-gridgain-ml.md#thread-pool-configuration) section in the quickstart guide.
{% endhint %}
...
For more information refer to [code deployment](../code-deployment.md) documentation.
