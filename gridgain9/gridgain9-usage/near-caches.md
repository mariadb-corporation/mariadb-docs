...
{% tab title="Embedded" %}
The example below assumes that the node is started and initialized as described in the [Embedded mode](../gridgain9-get-started/embedded-mode.md) documentation.
