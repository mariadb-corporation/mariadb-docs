...
create/add users when connecting over a domain socket, or use [TLS/SSL](mariadb-maxscale-2402-maxscale-2402-nosql-protocol-module.md#tls-ssl)
...
as explained [here](mariadb-maxscale-2402-maxscale-2402-nosql-protocol-module.md#roles-and-privileges).
...
the TLS/SSL support of listeners is available. Please see [TLS/SSL encryption](../maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md#tls-ssl-encryption)
for details.
...
as explained in [here](mariadb-maxscale-2402-maxscale-2402-nosql-protocol-module.md#roles-and-privileges).
...
content in the `doc` column using the [JSON functions](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/reference/sql-functions/special-functions/json-functions) of MariaDB.
