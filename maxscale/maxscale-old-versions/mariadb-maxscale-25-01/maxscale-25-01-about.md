---
description: >-
  What MariaDB MaxScale 25.01 is and what it does. MaxScale is a database proxy
  that forwards statements to one or more database servers, using pluggable
  protocol, router, and filter modules.
---
...
through MariaDB MaxScale. Filters are often used for logging queries or
...
building from source code, is included in the [MariaDB MaxScale Installation Guide](mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-installation-guide.md).

The same guide also provides basic information on running MariaDB MaxScale. More
detailed information about configuring MariaDB MaxScale can be found in the [Configuration Guide](mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-configuration-guide.md).
