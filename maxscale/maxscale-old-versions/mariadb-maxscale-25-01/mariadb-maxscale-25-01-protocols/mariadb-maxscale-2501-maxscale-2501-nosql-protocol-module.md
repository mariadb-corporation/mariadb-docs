...
the TLS/SSL support of listeners is available. Please see TLS/SSL encryption
for details.
...
as explained in [here](mariadb-maxscale-2501-maxscale-2501-nosql-protocol-module.md#roles-and-privileges).
