...
create/add users when connecting over a domain socket, or use [TLS/SSL](mariadb-maxscale-2302-nosql-protocol-module.md#tls-ssl)
...
as explained [here](mariadb-maxscale-2302-nosql-protocol-module.md#roles-and-privileges).
...
as explained in [here](mariadb-maxscale-2302-nosql-protocol-module.md#roles-and-privileges).
