...
* Use the [Python version of the schema generator](https://github.com/mariadb-corporation/MaxScale/blob/23.02/server/modules/protocol/examples/cdc_schema.py)
  and copy the generated .avsc files to the avrodir
