...
For a definitive list of packages, consult the [install\_build\_deps.sh](https://github.com/mariadb-corporation/MaxScale/blob/23.08/BUILD/install_build_deps.sh) script.
...
**Note**: You can look into [defaults.cmake](https://github.com/mariadb-corporation/MaxScale/blob/23.08/cmake/defaults.cmake) for a
