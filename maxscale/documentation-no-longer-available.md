...
The documentation for the MariaDB MaxScale release you are looking for is no longer available.

MariaDB MaxScale **21.06** and **22.08** have reached end of life. Neither series receives maintenance updates, and their documentation has been retired rather than repointed at a current release, because the behavior it described does not match any supported version.
