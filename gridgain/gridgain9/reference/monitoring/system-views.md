...
| VIEW_NAME | STRING | System view name. |
| COLUMN_NAME | STRING | Column name. |
| COLUMN_TYPE | STRING | Column type. Can be any of the [supported types](../sql/data-types.md). |
...
| TYPE | STRING | **Deprecated**. Column type. Can be any of the [supported types](../sql/data-types.md). |
