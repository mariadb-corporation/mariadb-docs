...
| events | The list of events tracked by the event channel. For the full list of event types, see [Events List](available-events.md). |
...
| Field | Description |
| --- | --- |
| type | The type of the event. For the full list of event types, see [Events List](available-events.md). |
| user | The name of the user, and the [authentication](../../security/authentication.md) provider used to authorize. |
