...
GridGain 8 and GridGain 9 differ in their support for [data types](../../reference/sql/data-types.md). Make sure data is mapped to columns of equivalent types. The table below provides a reference for commonly used types:
...
{% hint style="info" %}
You can prepare your tables by using the [Persistent Data Migration](persistent-data-migration.md) to replicate your caches.
{% endhint %}
