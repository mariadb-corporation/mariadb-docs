...
GridGain periodically starts the [checkpointing process](../../architecture/storage/engines/native-persistent-storage.md#checkpointing) that syncs dirty pages from memory to disk.
