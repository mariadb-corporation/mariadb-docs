...
- [About Distributed Computing](compute.md) — configure and execute compute jobs, including colocated execution, MapReduce tasks, and .NET jobs.
- [Object Serialization](serialization.md) — control how job arguments and results are marshalled between servers and clients.
- [WebAssembly Compute Jobs](wasm.md) — run code compiled to WebAssembly on cluster nodes.
