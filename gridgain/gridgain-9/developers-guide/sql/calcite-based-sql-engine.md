...
- **Cluster-wide System Views**: [System views](../../administrators-guide/metrics/system-views.md) in GridGain 9 provide cluster-wide information, dynamically updated;
