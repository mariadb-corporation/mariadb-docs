---
description: >-
  Install and register the GridGain 9 ODBC driver on Windows and Linux,
  configure the cluster, and use it with tools such as pyodbc.
---
...
GridGain 9 includes an ODBC driver that allows you both to select and to modify data stored in a distributed cache by using standard SQL queries and native ODBC API. ODBC driver uses your [client connection configuration](../../clients/overview.md).
...
For more information on configuring client connector, see [Client Connector Configuration](../../clients/overview.md#client-connector-configuration).
...
GridGain can be used with [pyodbc](https://pypi.org/project/pyodbc/). Here is how you can use pyodbc in GridGain 9:
