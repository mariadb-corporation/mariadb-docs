...
- [Overview](rest-api.md) — the OpenAPI specification, REST connector configuration, using HTTP tools, and running SQL over REST.
- [REST Authentication](security.md) — Basic and JWT Bearer authentication for REST requests.
