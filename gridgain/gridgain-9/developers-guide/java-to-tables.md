...
{% hint style="info" %}
You need to create a [storage profile](../administrators-guide/storage/README.md#creating-and-using-storage-profiles) in node configuration by using the CLI tool.
{% endhint %}
