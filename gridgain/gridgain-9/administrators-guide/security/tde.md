...
When [Ignite persistence](../storage/engines/aipersist.md) is turned on, all data in the cluster will be encrypted, including:

- Data on disk
- [Data snapshots](../snapshots/snapshots-and-recovery.md)
- RAFT log
- Meta storage
...
To enable encryption in the cluster, specify the path to your keystore in the cluster configuration by using the [CLI tool](../../ignite-cli-tool.md).
