...
Users and their roles are configured by using CLI or SQL. You can see the full list of CLI commands in the [GridGain CLI Tool](../../ignite-cli-tool.md) section, and SQL commands in [DDL reference](../../sql-reference/ddl.md).
...
- Grant a new privilege to the role. In this case, we will allow users with this role to create tables, but you can see the full list of roles in the [User Permissions and Roles](permissions.md) section.
