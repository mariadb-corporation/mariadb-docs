...
After defining storage profiles and [distribution zones](distribution-zones.md), you can create tables using SQL or [from code](../../developers-guide/java-to-tables.md). Both zone and storage profile cannot be changed after table creation.
