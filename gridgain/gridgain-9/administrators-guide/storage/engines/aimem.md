...
Volatile table partitions use [Raft](../../raft.md) for consensus. Each partition maintains a Raft log. You can configure the number of log entries kept in memory by allocating a _log storage budget_.
