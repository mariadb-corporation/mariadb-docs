...
In GridGain 9, configuration is managed using the [CLI utility](../../ignite-cli-tool.md). Configuration is stored in HOCON format and can be modified both at startup and during runtime.
...
You can also modify cluster configuration via [non-interactive](../../ignite-cli-tool.md#non-interactive-cli-mode) CLI mode without starting the tool first.
