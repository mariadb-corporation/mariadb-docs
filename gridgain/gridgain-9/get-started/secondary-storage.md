...
- Basic understanding of [distribution zones](../administrators-guide/storage/distribution-zones.md);
- Basic understanding of [storage profiles](../administrators-guide/storage/storage-profiles.md).
