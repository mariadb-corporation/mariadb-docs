...
For a conceptual overview, see [Row-Level Security](../administrators-guide/security/row-level-security.md).
...
apply as for the `USING` expression of [CREATE POLICY](access-control.md#create-policy).
...
- [GRANT TO role](access-control.md#grant-to-role)
- [REVOKE FROM role](access-control.md#revoke-from-role)
...
- [GRANT TO role](access-control.md#grant-to-role)
- [REVOKE FROM role](access-control.md#revoke-from-role)
- [GRANT TO user](access-control.md#grant-to-user)
- [REVOKE FROM user](access-control.md#revoke-from-user)
