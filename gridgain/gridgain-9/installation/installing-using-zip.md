...
- `gridgain9-cli-9.1` - this archive contains the [GridGain CLI tool](../ignite-cli-tool.md). This tool is the main way of interacting with GridGain clusters and nodes.
...
With the GridGain installed, you can proceed with the [Getting Started](../quick-start/getting-started-guide.md) or [use the available APIs](../developers-guide/table-api.md) immediately.
