...
{% hint style="info" %}
Take a [snapshot](../../administrators-guide/snapshots/snapshots-and-recovery.md) of your data before starting. If the update process fails, you will be able to restore your cluster state from snapshot.
{% endhint %}
