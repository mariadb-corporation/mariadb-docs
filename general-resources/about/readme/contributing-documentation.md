...
To make larger changes in one pull request, fork the repository, create an update branch, make the changes, and open a pull request to merge the branch upstream to the documentation team.
