...
* Fund the development of a specific feature. You can find a list of suggested features to sponsor [here](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/product-development/server-development/mariadb-server-roadmap#plans) or in [JIRA](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/product-development/server-development/tools/jira). Feel free to sign in and add more projects to either place!
