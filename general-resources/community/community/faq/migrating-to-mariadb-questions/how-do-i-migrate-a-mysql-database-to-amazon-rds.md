...
Gee-Hwan Chuang of Listia has written a guide titled Moving a Production MySQL Database to Amazon RDS with Minimal Downtime. He recommends using [mysqldump]({server}/clients-and-utilities/backup-restore-and-import-clients/mariadb-dump).
