...
The [How to contribute](https://github.com/MariaDB/server/blob/main/CONTRIBUTING.md) page in the MariaDB Server repository contains a lot of interesting links about
how to participate.

You can also consider [sponsoring a feature](../../../contributing-participating/sponsoring-the-mariadb-project.md).

Welcome to the [MariaDB community](../../../joining-the-community.md)!
