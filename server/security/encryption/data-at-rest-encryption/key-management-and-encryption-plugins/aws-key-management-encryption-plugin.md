...
Before you uninstall the plugin, you should ensure that [data-at-rest encryption](../data-at-rest-encryption-tde-fundamentals.md) is completely disabled, and that MariaDB no longer needs the plugin to decrypt tables or other files.
...
For more information on how to use encryption, see [data-at-rest encryption](../data-at-rest-encryption-tde-fundamentals.md).
