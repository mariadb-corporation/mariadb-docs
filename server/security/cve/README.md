...
{% hint style="info" %}
This page is about security vulnerabilities fixed in MariaDB products. If you are looking for information on securing your MariaDB installation, see [Securing MariaDB](../securing-mariadb/).
{% endhint %}
...
It is a publicly available and free-to-use database of known software vulnerabilities maintained at [https://cve.mitre.org/](https://cve.mitre.org/).
