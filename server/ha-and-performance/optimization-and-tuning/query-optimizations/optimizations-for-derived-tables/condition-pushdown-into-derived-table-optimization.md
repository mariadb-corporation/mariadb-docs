...
{% tabs %}
{% tab title="Current" %}
From MariaDB 12.1, it is possible to enable or disable the optimization with  [DERIVED_CONDITION_PUSHDOWN() and NO_DERIVED_CONDITION_PUSHDOWN() optimizer hints](../../optimizer-hints/expanded-optimizer-hints.md#-derived_condition_pushdown-no_derived_condition_pushdown).
{% endtab %}
