---
description: >-
  AdminNeo is a full-featured database management tool written in PHP that runs
  in a web browser. It manages MariaDB and other database systems from a single
  deployable file.
---
