...
`mariadb-fix-extensions` converts the extensions for [MyISAM](../../server-usage/storage-engines/myisam-storage-engine/README.md) (or ISAM) table files to their canonical forms.
