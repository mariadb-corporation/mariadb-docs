...
| [DELETE](../../reference/sql-statements/data-manipulation/changing-deleting-data/delete.md) | InnoDB finds corresponding rows in the child table             | ON DELETE NO ACTION | • Fails with [E](https://github.com/mariadb-corporation/mariadb-docs/blob/main/server/architecture/server-constraints/broken-reference/README.md)[ER\_ROW\_IS\_REFERENCED\_2](../../reference/error-codes/mariadb-error-codes-1400-to-1499/e1451.md) error code |
