...
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `old_alter_table`                                                                                                                                      | `Default`             | <p>Remove. Superseded by <code>alter_algorithm</code>. Using the variable upon upgrade to MariaDB 11.8 will return the error:[ERROR] /test/11.8.5-2/debug/sql/mariadbd: unknown variable 'OLD_ALTER_TABLE=YES<br></p>                                                        |
| `max_tmp_tables`                                                                                                                                       | `32`                  | Remove. Using the variable upon upgrade to MariaDB 11.8 will return the error: \[ERROR] /test/11.8.5-2/debug/sql/mariadbd: unknown variable 'MAX\_TMP\_TABLES=19900'                                                                                                         |
| `innodb_defragment_*`                                                                                                                                  | N/A                   | Remove. Manual InnoDB defragmentation is no longer supported. Using the variable upon upgrade to MariaDB 11.8 will return the warning: `innodb_defragment_*` _was removed. It does nothing now and exists only for compatibility with old `my.cnf` files._                   |
| `debug_no_thread_alarm`                                                                                                                                | N/A                   | Remove. Unused code. Using the variable upon upgrade to MariaDB 11.8 will return the error: _\[ERROR] /test/11.8.5-2/debug/sql/mariadbd: unknown variable 'DEBUG\_NO\_THREAD\_ALARM=ON'_                                                                                     |
| [`DATETIME_FORMAT`](../../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md#datetime_format)<sup>#</sup> | N/A                   | Remove. Use standard format strings. Using the variable upon upgrade to MariaDB 11.8 will return the warning: _`datetime-format`' was removed. It does nothing now and exists only for compatibility with old `my.cnf` files._                                               |
| [`DATE_FORMAT`](../../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md#date_format)<sup>#</sup>         | `%Y-%m-%d`            | Remove. Standard format strings are now enforced. Using the variable upon upgrade to MariaDB 11.8 will return the warning: _`date-format`' was removed. It does nothing now and exists only for compatibility with old `my.cnf` files._                                      |
| `TIME_FORMAT`                                                                                                                                          | `%H:%i:%s`            | Remove. Standard format strings are now enforced. Using the variable during the upgrade will return the warning: _`time_format`' was removed. It does nothing now and exists only for compatibility with old `my.cnf` files._                                                |
| `WSREP_STRICT_DDL`                                                                                                                                     | N/A                   | Remove. Replaced by `wsrep_mode=STRICT_REPLICATION`. Using the variable upon upgrade to MariaDB 11.8 will return the error: \[ERROR] /test/11.8.5-2/debug/sql/mariadbd: unknown variable 'WSREP\_STRICT\_DDL=ON'                                                             |
| `WSREP_CAUSAL_READS`                                                                                                                                   | `OFF`                 | <p>Remove. Superseded by <code>wsrep_sync_wait.</code><br>Using the variable during the upgrade will return the warning: <code>WSREP_CAUSAL_READS</code> <em>was removed. It does nothing now and exists only for compatibility with old <code>my.cnf</code> files.</em></p> |
| `WSREP_LOAD_DATA_SPLITTING`                                                                                                                            | `OFF`                 | Legacy Galera splitting logic removed. Using the variable upon upgrade to MariaDB 11.8 will return the error: \[ERROR] /test/11.8.5-2/debug/sql/mariadbd: unknown variable 'WSREP\_LOAD\_DATA\_SPLITTING=12432'                                                              |
| `WSREP_REPLICATE_MYISAM`                                                                                                                               | `OFF`                 | Remove. MyISAM replication support in Galera removed. Using the variable upon upgrade to MariaDB 11.8 will return the error: \[ERROR] /test/11.8.5-2/debug/sql/mariadbd: unknown variable 'WSREP\_LOAD\_DATA\_SPLITTING=12432'                                               |
...
| `innodb_change_buffering`                                                                                                                              | `none`                | Remove. Engine now handles this via SSD-optimized logic. Using the variable upon upgrade to MariaDB 11.8 will return the warning: `innodb_change_buffering` _was removed. It does nothing now and exists only for compatibility with old `my.cnf` files._                    |
| `innodb_change_buffer_max_size`                                                                                                                        | `25`                  | Remove. Using the variable now returns error: \[ERROR] /test/11.8.5-2/debug/sql/mariadbd: unknown variable 'INNODB\_CHANGE\_BUFFER\_MAX\_SIZE=12423                                                                                                                          |
| `innodb_version`                                                                                                                                       | `10.6.26`             | Remove. Using the variable now returns error: \[ERROR] /test/11.8.5-2/debug/sql/mariadbd: unknown variable 'innodb-version=123132'                                                                                                                                           |
