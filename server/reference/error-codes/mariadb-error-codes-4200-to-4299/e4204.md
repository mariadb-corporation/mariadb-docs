# Error 4204: Invalid vector format at offset

| Error Code | SQLSTATE | Error                       | Description                                                                          |
| ---------- | -------- | --------------------------- | ------------------------------------------------------------------------------------ |
| 4204       |          | ER\_VECTOR\_FORMAT\_INVALID | Invalid vector format at offset: %d for '%s'. Must be a valid JSON array of numbers. |
