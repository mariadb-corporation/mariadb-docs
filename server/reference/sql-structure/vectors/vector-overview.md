...
In MariaDB Enterprise Server, vector search was backported to the 11.4 release series and is available from [MariaDB Enterprise Server 11.4.5-3]({release-notes}/enterprise-server/11.4/11.4.5-3) onwards. It is also included in [MariaDB Enterprise Server 11.8]({release-notes}/enterprise-server/11.8/whats-new), which is generally available from 11.8.3-1 onwards.
