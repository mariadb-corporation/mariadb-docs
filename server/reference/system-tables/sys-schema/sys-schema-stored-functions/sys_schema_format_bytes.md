...
From [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/11.8/what-is-mariadb-118), the built-in [FORMAT\_BYTES](../../../sql-functions/secondary-functions/miscellaneous-functions/miscellaneous-functions-format_bytes.md) function can instead be used. The functions are similar, except that `FORMAT_BYTES` also displays exbibytes.
