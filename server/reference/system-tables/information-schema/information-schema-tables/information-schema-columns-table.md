...
| CHARACTER\_OCTET\_LENGTH        | Same as the `CHARACTER_MAXIMUM_LENGTH` except for multi-byte [character sets](../../../data-types/string-data-types/character-sets/).                                                                                                                                                                                                                 |
...
| CREATE\_OPTIONS                 | Extra [CREATE TABLE](../../../sql-statements/data-definition/create/create-table.md) options.This column is available from MariaDB 13.0.                                                                                                                                                                                                              |
