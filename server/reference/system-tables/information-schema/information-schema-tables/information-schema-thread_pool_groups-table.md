...
| IS\_STALLED      | whether there's currently an active worker thread in this group that has exceeded [thread\_pool\_stall\_limit](../../../../ha-and-performance/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md#thread_pool_stall_limit) time |
