...
| ACTION\_ORDER                 | Indicates the order that the action will be performed in (of the list of a table's triggers with identical `EVENT_MANIPULATION` and `ACTION_TIMING` values). See the [FOLLOWS/PRECEDES](../../../../server-usage/triggers-events/triggers/create-trigger.md#follows-precedes-_other_trigger_name) clauses.        |
