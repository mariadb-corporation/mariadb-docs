...
{% tab title="< 10.5.1" %}
The `WAIT FOR ALL SLAVES` option was first added in [MariaDB 10.4.4](https://github.com/mariadb-corporation/mariadb-docs/blob/main/server/release-notes/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-1044-release-notes/README.md).
{% endtab %}
{% endtabs %}
