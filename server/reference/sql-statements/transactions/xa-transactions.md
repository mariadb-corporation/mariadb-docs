...
In MariaDB, XA transactions can only be used with storage engines that support them. At least [InnoDB](../../../server-usage/storage-engines/innodb/), TokuDB, [SPIDER](../../../server-usage/storage-engines/spider/) and [MyRocks](../../../server-usage/storage-engines/myrocks/) support them. XA transactions are always supported.
