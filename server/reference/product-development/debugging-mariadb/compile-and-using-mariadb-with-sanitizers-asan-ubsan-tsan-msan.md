...
# Compiling and Using MariaDB With Sanitizers (ASAN, UBSAN, TSAN, MSAN)
...
| `WITH_ASAN_SCOPE=ON`                          | Enables Address Sanitizer Use after Scope checking                                                                                                        |
...
* [Compiling MariaDB for debugging](compiling-mariadb-for-debugging.md)
