...
* **2025-06-04** — Add support for MariaDB ES 11.8 versions
* **2025-01-16** — Change default to 11.4, adjust MaxScale repo URL
* **2025-01-07** — Fixes for 11.4 regex
* **2024-11-19** — Fix default version, still 10.6
* **2024-11-13** — Add support for MariaDB ES 11.4 versions
* **2024-09-20** — Disable enterprise-tools repository setup
* **2024-09-09**
...
* **2024-06-12** — Add support for RHEL 9 ppc64le
* **2023-07-27** — Adjust regex to support MariaDB ES 23.x versions
* **2023-07-27** — Add Debian 12 Bookworm
