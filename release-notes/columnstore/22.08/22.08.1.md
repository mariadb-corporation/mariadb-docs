...
[MariaDB ColumnStore]({analytics}/mariadb-columnstore) 22.08.1 is a maintenance release of [MariaDB ColumnStore]({analytics}/mariadb-columnstore) . MariaDB ColumnStore is a columnar storage engine included with MariaDB Enterprise Server. This is the first release in the ColumnStore 22.08 series.
