...
[MariaDB ColumnStore]({analytics}/mariadb-columnstore) 22.08.8 is a maintenance release of [MariaDB ColumnStore]({analytics}/mariadb-columnstore). MariaDB ColumnStore is a columnar storage engine included with MariaDB Enterprise Server.
