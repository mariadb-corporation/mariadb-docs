...
Cluster Management API (CMAPI) 1.6.2 is a maintenance release of CMAPI. CMAPI is a REST API for administering [MariaDB ColumnStore]({analytics}/mariadb-columnstore) in multi-node topologies.
