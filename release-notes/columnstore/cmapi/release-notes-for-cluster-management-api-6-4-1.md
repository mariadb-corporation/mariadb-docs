...
Cluster Management API (CMAPI) 6.4.1 is a maintenance release of CMAPI. CMAPI is a REST API for administering [MariaDB ColumnStore](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/rBEU9juWLfTDcdwF3Q14/mariadb-columnstore) in multi-node topologies.
