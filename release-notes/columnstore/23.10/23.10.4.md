...
* CTE/aggregation function give wrong results ([MCOL-5842](https://jira.mariadb.org/browse/MCOL-5842))
...
In alignment with the [enterprise lifecycle](../../enterprise-server/about/enterprise-server-lifecycle.md), MariaDB ColumnStore 23.10.3 is provided for:
