...
| ----------------------------------------------------------------- | ---------------------- |
| [CVE-2026-47064](https://www.cve.org/CVERecord?id=CVE-2026-47064) | 6.5                    |
...
* Packages for Ubuntu 26.04 LTS "Resolute" are now available
...
* Potential MariaDB Cluster hang when a DDL command or Sequence access is replicated to a cluster by async replication ([MENT-2671](https://jira.mariadb.org/browse/MENT-2671), [MDEV-38260](https://jira.mariadb.org/browse/MDEV-38260))
