...
<a href="https://mariadb.com/downloads/enterprise/enterprise-server/" class="button primary">Download</a> <a href="11.8.8-5.md" class="button secondary">Release Notes</a> <a href="changelog-11.8.8-5.md" class="button secondary">Changelog</a> <a href="whats-new.md" class="button secondary">Overview of Enterprise Server 11.8</a>
...
* vector index sizes are not in information_schema.TABLES nor SHOW TABLE STATUS ([MDEV-35821](https://jira.mariadb.org/browse/MDEV-35821))
...
* Server crashes when executing UPDATE ... FOR PORTION OF with a normal table ([MDEV-39356](https://jira.mariadb.org/browse/MDEV-39356))
...
* Reduced buffer pool flushing contention under sustained write pressure. ([MENT-2686](https://jira.mariadb.org/browse/MENT-2686))
...
* CREATE TABLE t SELECT vec_fromtext(...) now correctly creates the column as a VECTOR TYPE. Contribution thanks to Abhishek Bansal. ([MDEV-35211](https://jira.mariadb.org/browse/MDEV-35211))
...
For the complete list of changes in this release, see the [changelog](changelog-11.8.8-5.md).

## Platforms <a href="#platforms" id="platforms"></a>

In alignment to the enterprise lifecycle, MariaDB Enterprise Server 11.8.8-5 is provided for:
