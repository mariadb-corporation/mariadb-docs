...
MariaDB Enterprise Server 11.4.5-3 is a Stable (GA) maintenance release of [MariaDB Enterprise Server](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/aEnK0ZXmUbJzqQrTjFyb/enterprise-server) 11.4. This release includes a variety of fixes.
...
* [Galera](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7) updated to [26.4.21](../../galera-cluster/26.4/26.4.21.md)
...
* Fix possible crash where server could not construct a geometry object from the input ([MDEV-33987](https://jira.mariadb.org/browse/MDEV-33987))
