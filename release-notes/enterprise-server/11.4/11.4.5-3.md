...
MariaDB Enterprise Server 11.4.5-3 is a Stable (GA) maintenance release of [MariaDB Enterprise Server]({release-notes}/enterprise-server) 11.4. This release includes a variety of fixes.
...
* [Galera]({galera}) updated to [26.4.21](../../galera-cluster/26.4/26.4.21.md)
