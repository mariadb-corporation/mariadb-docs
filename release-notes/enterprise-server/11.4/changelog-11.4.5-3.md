...
MariaDB Enterprise Server 11.4.5-3 is a Stable (GA) maintenance release of [MariaDB Enterprise Server](../) 11.4. For the categorized highlights and other details of this release, see the [release notes](11.4.5-3.md).
