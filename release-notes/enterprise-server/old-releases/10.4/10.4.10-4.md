...
* Improved [MariaDB Enterprise Cluster](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7/) error logging to explain that GCache recovery is not possible when GCache encryption is enabled. (MENT-373)
...
* [DELETE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/changing-deleting-data/delete) from child table with `FOREIGN KEY` was not possible when the table is System-Versioned. ([MDEV-20812](https://jira.mariadb.org/browse/MDEV-20812))
