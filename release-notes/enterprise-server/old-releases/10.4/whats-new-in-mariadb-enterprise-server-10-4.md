...
MariaDB Enterprise Server uses an [enterprise lifecycle](../../about/enterprise-server-lifecycle.md) that provides optimized builds, predictable release behavior, and vendor support.
