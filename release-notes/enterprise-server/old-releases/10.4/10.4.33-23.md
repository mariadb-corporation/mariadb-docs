...
MariaDB Enterprise Server 10.4.33-23 is a maintenance release of MariaDB Enterprise Server 10.4. This release includes a variety of fixes.
...
* TaskMax not set to infinity in the MariaDB systemd unit, therefore a lower number than defined in `max_connections` might be possible for the number of connections ([MDEV-30236](https://jira.mariadb.org/browse/MDEV-30236))
...
In alignment to the [enterprise lifecycle](../../about/enterprise-server-lifecycle.md), MariaDB Enterprise Server 10.4.33-23 is provided for:
