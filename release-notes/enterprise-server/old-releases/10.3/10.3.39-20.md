...
MariaDB Enterprise Server 10.3.39-20 is a maintenance release of [MariaDB Enterprise Server]({release-notes}/enterprise-server) 10.3. |This release includes a variety of fixes.
