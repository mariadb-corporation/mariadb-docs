...
This ninth release of [MariaDB Enterprise Server]({release-notes}/enterprise-server) 10.3 is a hotfix release to address a CVE which has been rated "critical" using the criteria defined in the MariaDB Engineering Policy.
