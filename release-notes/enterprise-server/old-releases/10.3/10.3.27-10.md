...
* Table can disappear after ALTER TABLE command if [SET FOREIGN\_KEY\_CHECKS=0](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#foreign_key_checks) is used before altering a child table to remove a primary key. ([MDEV-22934](https://jira.mariadb.org/browse/MDEV-22934))
...
* mysqldump will not dump sequence definition details on `--no-data` dump. ([MDEV-21786](https://jira.mariadb.org/browse/MDEV-21786))
