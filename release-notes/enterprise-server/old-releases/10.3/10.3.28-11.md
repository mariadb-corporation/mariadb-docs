...
* Sequences, which are used as the default by a table, are not dumped in the right order by mysqldump ([MDEV-21785](https://jira.mariadb.org/browse/MDEV-21785))

### Related to install and upgrade

* mysql\_upgrade fails with error messages ALGORITHM=INSTANT is not supported for this operation ([MDEV-16735](https://jira.mariadb.org/browse/MDEV-16735))
...
* [mariadb-backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup) --log-innodb-page-corruption command-line option added
