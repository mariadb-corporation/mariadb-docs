...
* The collation column in the [information\_schema.STATISTICS](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/information-schema/information-schema-tables/information-schema-statistics-table) table is incorrectly read as NULL. ([MDEV-4621](https://jira.mariadb.org/browse/MDEV-4621))
