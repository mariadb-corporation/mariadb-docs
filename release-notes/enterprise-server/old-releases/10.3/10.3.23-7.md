...
| [CVE-2020-13249](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-13249) | N/A (Medium)[#1](10.3.23-7.md#1) |
...
* mysqldump has a new `--ignore-table-data=<table>` option. When used, the dump will include the table definition for the listed tables, but not the INSERT statements for the data in the table. ([MDEV-22037](https://jira.mariadb.org/browse/MDEV-22037))
...
In alignment with the [enterprise lifecycle](../../about/enterprise-server-lifecycle.md), MariaDB Enterprise Server 10.3.23-7 is provided for:
