...
* [InnoDB](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb) assertion on [TRUNCATE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-functions/numeric-functions/truncate) after `[ALTER TABLE]({server}/reference/sql-statements/data-definition/alter/alter-table) .. DISCARD TABLESPACE` ([MDEV-23705](https://jira.mariadb.org/browse/MDEV-23705))
...
* An `[ALTER TABLE]({server}/reference/sql-statements/data-definition/alter/alter-table) .. RENAME` to change a column to uppercase doesn't work. ([MDEV-23852](https://jira.mariadb.org/browse/MDEV-23852))
