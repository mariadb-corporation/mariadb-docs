...
MariaDB Enterprise Server 10.5.24-18 is a maintenance release of [MariaDB Enterprise Server]({release-notes}/enterprise-server) 10.5. This release includes a variety of fixes.
...
* [Enterprise Spider Sharded Topology with MariaDB Enterprise Server 10.5]({server}/architecture/topologies/spider-sharded)
* [Enterprise Spider Federated Topology with MariaDB Enterprise Server 10.5]({server}/architecture/topologies/spider-federated)
