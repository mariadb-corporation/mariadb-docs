...
* When a view is queried using a prepared statement, the query fails with the [ER\_NEED\_REPREPARE error code]({server}/reference/error-codes/mariadb-error-codes-1600-to-1699/e1615). ([MDEV-17124](https://jira.mariadb.org/browse/MDEV-17124))
...
* When `XA COMMIT` is executed without an open XA transaction, the operation is still logged to the binary log. ([MDEV-25616](https://jira.mariadb.org/browse/MDEV-25616))
  * In previous releases, when a replica node tried to apply the event, it would fail with the [ER\_XAER\_NOTA error code]({server}/reference/error-codes/mariadb-error-codes-1300-to-1399/e1397):
...
* When [mariadb-upgrade]({server}/server-usage/backup-and-restore/mariadb-backup) is executed, spurious errors about table rebuilds are logged. ([MDEV-29481](https://jira.mariadb.org/browse/MDEV-29481))
...
* [ER\_BINLOG\_UNSAFE\_SKIP\_LOCKED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4175) error code added
* [ER\_CM\_OPTION\_MISSING\_REQUIREMENT]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4191) error code added
* [ER\_INCONSISTENT\_SLAVE\_TEMP\_TABLE]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4188) error code added
* [ER\_JSON\_HISTOGRAM\_PARSE\_FAILED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4186) error code added
* [ER\_JSON\_TABLE\_ALIAS\_REQUIRED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4177) error code added
* [ER\_JSON\_TABLE\_ERROR\_ON\_FIELD]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4176) error code added
* [ER\_JSON\_TABLE\_MULTIPLE\_MATCHES]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4179) error code added
* [ER\_JSON\_TABLE\_SCALAR\_EXPECTED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4178) error code added
* [ER\_PARTITION\_CONVERT\_SUBPARTITIONED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4184) error code added
* [ER\_PK\_INDEX\_CANT\_BE\_IGNORED](../10-5/broken-reference/) error code added
* [ER\_PROVIDER\_NOT\_LOADED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4185) error code added
* [ER\_REMOVED\_ORPHAN\_TRIGGER]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4181) error code added
* [ER\_SF\_OUT\_INOUT\_ARG\_NOT\_ALLOWED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4187) error code added
* [ER\_SLAVE\_STATEMENT\_TIMEOUT]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4192) error code added
* [ER\_STORAGE\_ENGINE\_DISABLED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4182) error code added
* [ER\_VERS\_HIST\_PART\_FAILED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4189) error code added
* [ER\_WITH\_TIES\_NEEDS\_ORDER]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4180) error code added
...
* [WARN\_OPTION\_CHANGING]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4190) error code added
* [WARN\_SFORMAT\_ERROR]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4183) error code added
