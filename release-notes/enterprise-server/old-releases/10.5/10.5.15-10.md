...
* When a [Spider](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/spider) table uses a [FLOAT]({server}/reference/data-types/numeric-data-types/float) column, the server can crash with an assertion failure. ([MDEV-27184](https://jira.mariadb.org/browse/MDEV-27184))
