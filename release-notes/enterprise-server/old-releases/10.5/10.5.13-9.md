...
MariaDB Enterprise Server 10.5.13-9 is a maintenance release of [MariaDB Enterprise Server]({release-notes}/enterprise-server) 10.5. This release includes a variety of fixes.
...
* Executing [CREATE OR REPLACE TABLE AS SELECT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/tables/create-table) under [LOCK TABLE]({server}/reference/sql-statements/transactions/lock-tables) can cause in a crash. ([MDEV-23391](https://jira.mariadb.org/browse/MDEV-23391))
...
* [MariaDB Enterprise Cluster]({galera}) hangs while it is executing `DELETE FROM mysql.wsrep_cluster`, which can be seen in the process list. ([MDEV-26760](https://jira.mariadb.org/browse/MDEV-26760), [MDEV-25883](https://jira.mariadb.org/browse/MDEV-25883))
...
* [MariaDB Enterprise Cluster]({galera}) can crash due to an incorrect conflict resolution on multi-master setup. ([MDEV-26099](https://jira.mariadb.org/browse/MDEV-26099), [MDEV-24294](https://jira.mariadb.org/browse/MDEV-24294), [MDEV-25114](https://jira.mariadb.org/browse/MDEV-25114))
