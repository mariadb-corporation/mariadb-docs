...
MariaDB Enterprise Server 10.5.13-9 is a maintenance release of [MariaDB Enterprise Server](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/aEnK0ZXmUbJzqQrTjFyb/enterprise-server) 10.5. This release includes a variety of fixes.
...
* Executing [CREATE OR REPLACE TABLE AS SELECT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/tables/create-table) under [LOCK TABLE](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/transactions/lock-tables) can cause in a crash. ([MDEV-23391](https://jira.mariadb.org/browse/MDEV-23391))
...
* [MariaDB Enterprise Cluster](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7) hangs while it is executing `DELETE FROM mysql.wsrep_cluster`, which can be seen in the process list. ([MDEV-26760](https://jira.mariadb.org/browse/MDEV-26760), [MDEV-25883](https://jira.mariadb.org/browse/MDEV-25883))
...
* [MariaDB Enterprise Cluster](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7) can crash due to an incorrect conflict resolution on multi-master setup. ([MDEV-26099](https://jira.mariadb.org/browse/MDEV-26099), [MDEV-24294](https://jira.mariadb.org/browse/MDEV-24294), [MDEV-25114](https://jira.mariadb.org/browse/MDEV-25114))
...
In alignment with the [enterprise lifecycle](../../about/enterprise-server-lifecycle.md), MariaDB Enterprise Server 10.5.13-9 is provided for:
