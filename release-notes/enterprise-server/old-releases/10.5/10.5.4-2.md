...
This release of [MariaDB Enterprise Server]({release-notes}/enterprise-server) 10.5 is the first GA (Generally Available) release. It Includes a variety of new features.
...
* [MariaDB Enterprise Cluster]({galera}) based on Galera 4.1
