...
* [`CREATE TABLE`](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-definition/create/create-table) `.. SELECT` FROM does not create table if [VALUE()](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-functions/secondary-functions/miscellaneous-functions/values-value) is not using a scalar value. ([MDEV-24618](https://jira.mariadb.org/browse/MDEV-24618))
