...
* MariaDB Enterprise Backup crashes when executed with the [--backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#backup) and [--databases-exclude](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#databases-exclude) options. ([MDEV-25815](https://jira.mariadb.org/browse/MDEV-25815))
...
* For [INSERT .. RETURNING](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/inserting-loading-data/insertreturning) statements, a qualified asterisk (such as `table_name.*`) is not supported in the RETURNING clause. ([MDEV-23178](https://jira.mariadb.org/browse/MDEV-23178))
