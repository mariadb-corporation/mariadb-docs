...
This tenth release of [MariaDB Enterprise Server]({release-notes}/enterprise-server) 10.2 is a maintenance release. This release includes security fixes.
...
* Galera wsrep library updated to 25.3.31 in [MariaDB Enterprise Cluster]({galera}).
...
* Better MariaDB GTID support for the [mariadb-backup --slave-info]({server}/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#slave-info) option. ([MDEV-19264](https://jira.mariadb.org/browse/MDEV-19264))
...
* [Galera]({galera}) got stuck after `FLUSH TABLES` ([MDEV-22707](https://jira.mariadb.org/browse/MDEV-22707))
...
* [MariaDB Enterprise Backup]({server}/server-usage/backup-and-restore/mariadb-backup) reports an error that it cannot find an [Aria](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/aria) log file `'./aria_log.00000000'` (MENT-907)
* [MariaDB Enterprise Backup]({server}/server-usage/backup-and-restore/mariadb-backup) failure for incremental backups. ([MDEV-24026](https://jira.mariadb.org/browse/MDEV-24026))
...
* [MariaDB Enterprise Backup]({server}/server-usage/backup-and-restore/mariadb-backup) SST fails for [MariaDB Enterprise Cluster]({galera}) if data-directory has lost+found directory. ([MDEV-21951](https://jira.mariadb.org/browse/MDEV-21951))
...
* [ER\_BASE64\_DECODE\_ERROR]({server}/reference/error-codes/mariadb-error-codes-1500-to-1599/e1575) upon replaying binary log. ([MDEV-16372](https://jira.mariadb.org/browse/MDEV-16372))
