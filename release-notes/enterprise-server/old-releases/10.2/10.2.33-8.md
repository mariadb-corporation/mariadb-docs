...
This eighth release of [MariaDB Enterprise Server]({release-notes}/enterprise-server) 10.2 is a maintenance release, including a variety of fixes.
...
* [mariadb-backup --prepare]({server}/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#prepare) does not stop on errors while applying InnoDB redo log. ([MDEV-22354](https://jira.mariadb.org/browse/MDEV-22354))
