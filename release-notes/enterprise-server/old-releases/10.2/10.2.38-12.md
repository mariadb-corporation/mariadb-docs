...
* [MariaDB Client](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/clients-and-utilities/mariadb-client) crashes when --default-character-set is set and --character-sets-dir is undefined. ([MDEV-24879](https://jira.mariadb.org/browse/MDEV-24879))
...
* Query returns a [ER\_BAD\_FIELD\_ERROR](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/error-codes/mariadb-error-codes-1000-to-1099/e1054) error when a subquery contains a JOIN with an ON clause that references an outer column. ([MDEV-25002](https://jira.mariadb.org/browse/MDEV-25002))
* Query returns a [ER\_BAD\_FIELD\_ERROR](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/error-codes/mariadb-error-codes-1000-to-1099/e1054) error when a Common Table Expression (CTE) contains a `UNION` ([MDEV-24597](https://jira.mariadb.org/browse/MDEV-24597))
...
* State snapshot transfer (SST) for [MariaDB Enterprise Cluster](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7/) using [MariaDB Enterprise Server](../../) fails when the password for the backup user is set via the `MYSQL_PWD` environment variable. ([MDEV-25321](https://jira.mariadb.org/browse/MDEV-25321))
...
* [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-enterprise-backup) logs an error instead of a warning when it reads an invalid log block checksum during a [--backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#backup). ([MDEV-25456](https://jira.mariadb.org/browse/MDEV-25456))
