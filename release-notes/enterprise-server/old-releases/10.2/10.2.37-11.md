...
This eleventh release of [MariaDB Enterprise Server]({release-notes}/enterprise-server) 10.2 is a maintenance release. This release includes security fixes.
...
* Plugin system variables and activation options can break [mysqld --wsrep\_recover](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/starting-and-stopping-mariadb/mariadbd) for [MariaDB Enterprise Cluster]({galera}). ([MDEV-20717](https://jira.mariadb.org/browse/MDEV-20717))
