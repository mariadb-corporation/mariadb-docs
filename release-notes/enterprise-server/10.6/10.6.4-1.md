...
* Extensive internal optimizations, including a refactoring of [InnoDB storage engine]({server}/server-usage/storage-engines/innodb) code.
* Atomic DDL
...
* An ignored index cannot be referenced in index hints, such as `FORCE INDEX, IGNORE INDEX, or USE INDEX`. When you try to reference an ignored index in an index hint, the server raises an error with the [ER\_KEY\_DOES\_NOT\_EXISTS]({server}/reference/error-codes) error code:
...
* [ER\_PK\_INDEX\_CANT\_BE\_IGNORED]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4174) error code added
...
* [ER\_UNSUPPORTED\_COMPRESSED\_TABLE]({server}/reference/error-codes/mariadb-error-codes-4100-to-4199/e4179) error code replaces [ER\_UNSUPPORT\_COMPRESSED\_TEMPORARY\_TABLE]({server}/reference/error-codes/mariadb-error-codes-4000-to-4099/e4047)
* [ER\_UNUSED\_26]({server}/reference/error-codes) error code replaces [ER\_COMMULTI\_BADCONTEXT]({server}/reference/error-codes/mariadb-error-codes-4000-to-4099/e4000)
* [ER\_UNUSED\_27]({server}/reference/error-codes) error code replaces [ER\_BAD\_COMMAND\_IN\_MULTI]({server}/reference/error-codes/mariadb-error-codes-4000-to-4099/e4001)
* [ER\_UNUSED\_28]({server}/reference/error-codes) error code replaces [ER\_TABLE\_IN\_FK\_CHECK]({server}/reference/error-codes/mariadb-error-codes-1700-to-1799/e1725)
...
* `mariadb-backup` [--debug-sleep-before-unlock]({server}/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#-debug-sleep-before-unlock) command-line option removed
* `mariadb-backup` [--debug-sync]({server}/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#-debug-sync) command-line option removed
* `mariadb-backup` [--innodb-log-files-in-group]({server}/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#-innodb-log-files-in-group) command-line option removed
