...
* When the same values are used with an [IN operator](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/operators/comparison-operators/in) and with an [= operator](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/operators/comparison-operators/equal), the optimizer chooses a different execution plan. (MENT-1630, [MDEV-29662](https://jira.mariadb.org/browse/MDEV-29662))
...
* [ER\_DROP\_PARTITION\_NON\_EXISTENT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/error-codes/mariadb-error-codes-1500-to-1599/e1507) error code replaced with [ER\_PARTITION\_DOES\_NOT\_EXIST](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/error-codes/mariadb-error-code-reference)
...
* [ER\_JSON\_HISTOGRAM\_PARSE\_FAILED](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/error-codes/mariadb-error-codes-4100-to-4199/e4196) error code added
* [ER\_KEY\_COLUMN\_DOES\_NOT\_EXITS](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/error-codes/mariadb-error-codes-1000-to-1099/e1072) error code replaced with [ER\_KEY\_COLUMN\_DOES\_NOT\_EXIST](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/error-codes/mariadb-error-code-reference)
