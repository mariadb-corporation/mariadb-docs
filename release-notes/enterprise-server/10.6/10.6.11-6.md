...
* When the same values are used with an [IN operator](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/operators/comparison-operators/in) and with an [= operator]({server}/reference/sql-structure/operators/comparison-operators/equal), the optimizer chooses a different execution plan. (MENT-1630, [MDEV-29662](https://jira.mariadb.org/browse/MDEV-29662))
