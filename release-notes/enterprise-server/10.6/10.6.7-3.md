...
MariaDB Enterprise Server 10.6.7-3 is a Stable (GA) maintenance release of [MariaDB Enterprise Server](../) 10.6. This release includes a variety of fixes.
...
* When a CTE is used in a subquery of a `DELETE` statement, the server incorrectly raises an error with the [ER\_NO\_DB\_ERROR](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/error-codes/mariadb-error-codes-1000-to-1099/e1046) error code. ([MDEV-26470](https://jira.mariadb.org/browse/MDEV-26470))
