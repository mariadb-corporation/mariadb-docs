...
* Optimize reorderable [LEFT JOINs](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/joins/join-syntax) statements ([MDEV-36055](https://jira.mariadb.com/browse/MDEV-36055))
* Optimize ordered scans over [`PARTITION BY RANGE`](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/partitioning-tables/partitioning-types/range-partitioning-type) ([MDEV-37330](https://jira.mariadb.com/browse/MDEV-37330))
