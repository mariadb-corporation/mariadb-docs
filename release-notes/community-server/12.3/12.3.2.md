...
* Optimize reorderable [`LEFT JOIN`](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/joins/join-syntax) statements ([MDEV-36055](https://jira.mariadb.com/browse/MDEV-36055))
