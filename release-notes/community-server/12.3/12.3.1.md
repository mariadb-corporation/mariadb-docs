...
[MariaDB 12.3](mariadb-12.3-changes-and-improvements.md) is a [rolling release](../about/release-model.md). It is an evolution of [MariaDB 12.2](../12.2/mariadb-12.2-changes-and-improvements.md) with several entirely new features.
