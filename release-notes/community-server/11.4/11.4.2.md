...
For a complete list of changes made in [MariaDB 11.4.2](11.4.2.md), with links to detailed information on each push, see the [changelog](../changelogs/11.4/11.4.2.md).
