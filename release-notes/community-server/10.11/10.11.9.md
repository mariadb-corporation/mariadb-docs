...
* [ALTER TABLE...ALGORITHM=COPY](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-definition/alter/alter-table#algorithm-copy) now builds indexes more efficiently ([MDEV-33087](https://jira.mariadb.org/browse/MDEV-33087))
