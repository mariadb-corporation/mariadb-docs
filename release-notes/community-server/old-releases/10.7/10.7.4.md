...
[MariaDB 10.7](what-is-mariadb-107.md) is the current short-term maintenance stable series of MariaDB. It is an evolution of [MariaDB 10.6](../../10.6/what-is-mariadb-106.md) with several entirely new features.
...
For a complete list of changes made in [MariaDB 10.7.4](10.7.4.md), with links to detailed information on each push, see the [changelog](../../changelogs/10.7/10.7.4.md).
