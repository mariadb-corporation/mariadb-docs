...
For a complete list of changes made in [MariaDB 10.7.5](10.7.5.md), with links to detailed information on each push, see the [changelog](../../changelogs/10.7/10.7.5.md).
