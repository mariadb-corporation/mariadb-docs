...
For a complete list of changes made in [MariaDB 10.9.4](10.9.4.md), with links to detailed information on each push, see the [changelog](../../changelogs/10.9/10.9.4.md).
