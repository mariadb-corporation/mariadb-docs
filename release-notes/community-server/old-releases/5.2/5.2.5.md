...
Like [previous releases](../../README.md), [MariaDB 5.2.5](5.2.5.md) includes several bug
fixes and other improvements. Specific bugs fixed in [MariaDB 5.2.5](5.2.5.md) are listed
in the [MariaDB 5.2.5 Changelog](../../changelogs/changelogs-mariadb-52-series/mariadb-525-changelog.md) and [MariaDB 5.1.55 Changelog](../../changelogs/changelogs-mariadb-51-series/mariadb-5155-changelog.md).
