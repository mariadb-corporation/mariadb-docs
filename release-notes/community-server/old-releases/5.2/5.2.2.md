...
beta releases) was to fix bugs and otherwise prepare for a stable release of [MariaDB 5.2](changes-improvements-in-mariadb-5-2.md). So, as in [previous releases](../../README.md), in [MariaDB 5.2.2](5.2.2.md)
