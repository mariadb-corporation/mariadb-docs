...
For a list of changes made in this release, with links to detailed information on each push, see the [MariaDB 5.2.14 Changelog](../../changelogs/changelogs-mariadb-52-series/mariadb-5214-changelog.md).
...
This release includes [MariaDB 5.1.67](../5.1/5.1.67.md) and (by extension) MySQL 5.1.67. See [Changes in MySQL 5.1.67](https://dev.mysql.com/doc/relnotes/mysql/5.1/en/news-5-1-67.html) for what changed in MySQL.
