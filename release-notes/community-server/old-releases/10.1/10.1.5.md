...
* mysqldump has been speeded up for large tables ([MDEV-6714](https://jira.mariadb.org/browse/MDEV-6714))
...
* Numerous [encryption](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/security/encryption/data-at-rest-encryption) bugfixes.
