...
* Administration
  * [MDEV-6248](https://jira.mariadb.org/browse/MDEV-6248), GUI-friendly cmake options to enable/disable plugins - MariaDB now uses PLUGIN\_xxx cmake options to enable or disable plugins, not a combination of WITH\_xxx, WITHOUT\_xxx, WITH\_PLUGINX\_xxx, WITHOUT\_PLUGIN\_xxx, WITH\_xxx\_STORAGE\_ENGINE, WITHOUT\_xxx\_STORAGE\_ENGINE. See [Specifying What Plugins to Build](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/compiling-mariadb-from-source/compiling-mariadb-with-extra-modulesoptions/specifying-which-plugins-to-build).
