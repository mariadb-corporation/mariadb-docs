...
* [Galera](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7/) is merged into MariaDB server, [MariaDB 10.1.1](10.1.1.md) binaries automatically support Galera out of the box.
...
For a complete list of changes made in [MariaDB 10.1.1](10.1.1.md), with links to detailed information on each push, see the [changelog](../../changelogs/changelogs-mariadb-101-series/mariadb-10-1-1-changelog.md).
