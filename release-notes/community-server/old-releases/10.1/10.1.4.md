...
* Lots of changes related to encryption. See the [updated documentation]({server}/security/encryption/data-at-rest-encryption/data-at-rest-encryption-tde-fundamentals). In particular:
