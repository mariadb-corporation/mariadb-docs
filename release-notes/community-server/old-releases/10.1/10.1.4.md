...
* Lots of changes related to encryption. See the [updated documentation](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/security/encryption/data-at-rest-encryption/data-at-rest-encryption-tde-fundamentals). In particular:
  ...
  * “Key management plugin” type was expanded and renamed to match the new broader set of responsibilities. It is now called [encryption plugin](https://mariadb.com/docs/release-notes/enterprise-server/about/mariadb-enterprise-server-differences/mariadb-enterprise-server-data-at-rest-encryption/encryption-plugins).
...
For a complete list of changes made in [MariaDB 10.1.4](10.1.4.md), with links to detailed information on each push, see the [changelog](../../changelogs/changelogs-mariadb-101-series/mariadb-10-1-4-changelog.md).
