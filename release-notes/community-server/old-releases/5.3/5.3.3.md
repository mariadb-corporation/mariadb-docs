...
[Download](https://downloads.askmonty.org/mariadb/5.3.3) |**Release Notes** |[Changelog](../../changelogs/changelogs-mariadb-53-series/mariadb-533-changelog.md) |[Overview of 5.3](changes-improvements-in-mariadb-5-3.md)

**Release date:** 21 Dec 2011

[MariaDB 5.3.3](5.3.3.md) is a [Release Candidate](../../about/release-criteria.md) release. In general this means that there are no known serious bugs, except for those marked as feature requests and no bugs were fixed since last the release which caused any notable code changes. We believe the code is ready for general usage (based on bug inflow), but we want more testing before calling it stable.

[MariaDB 5.3](changes-improvements-in-mariadb-5-3.md) radically improves performance for subqueries as well as for joins and single-table queries over large data sets.
...
Compared to [MariaDB 5.3.0](5.3.0.md), 5.3.1, and 5.3.2, [MariaDB 5.3.3](5.3.3.md) is a bug-fix release with a focus on stability, performance, and usability. It is the third beta release of the 5.3 series and fixes bugs found in the initial 5.3.0 and\
5.3.1 beta releases.
...
* Performance:
  * More optimizer features have been thoroughly tested, and switched on by default:
    ...
    * Nested loop join will use its [Block-based variant](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/query-optimizer/block-based-join-algorithms#block-nested-loop-join) more aggressively
...
For a list of every change made in [MariaDB 5.3.3](5.3.3.md), with links to detailed information on each push, see the [MariaDB 5.3.3 Changelog](../../changelogs/changelogs-mariadb-53-series/mariadb-533-changelog.md). It is worth noting that [MariaDB 5.3](changes-improvements-in-mariadb-5-3.md) is built on [MariaDB 5.2](../5.2/changes-improvements-in-mariadb-5-2.md),[MariaDB 5.1](../5.1/changes-improvements-in-mariadb-5-1.md), and MySQL 5.1.
