...
* Performance:
  * More optimizer features have been thoroughly tested, and switched on by default:
    ...
    * Nested loop join will use its [Block-based variant]({server}/ha-and-performance/optimization-and-tuning/query-optimizer/block-based-join-algorithms#block-nested-loop-join) more aggressively
