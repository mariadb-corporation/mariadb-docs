...
* Performance:
  * More optimizer features have been thoroughly tested, and switched on by default:
    ...
    * Nested loop join will use its [Block-based variant](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/query-optimizer/block-based-join-algorithms#block-nested-loop-join) more aggressively
...
information on each push, see the [MariaDB 5.3.3 Changelog](../../changelogs/changelogs-mariadb-53-series/mariadb-533-changelog.md). It is worth noting that [MariaDB 5.3](changes-improvements-in-mariadb-5-3.md) is built on [MariaDB 5.2](../5.2/changes-improvements-in-mariadb-5-2.md),[MariaDB 5.1](../5.1/changes-improvements-in-mariadb-5-1.md), and MySQL 5.1.
