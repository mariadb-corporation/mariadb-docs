...
For a complete list of changes made in [MariaDB 10.8.6](10.8.6.md), with links to detailed information on each push, see the [changelog](../../changelogs/10.8/10.8.6.md).
