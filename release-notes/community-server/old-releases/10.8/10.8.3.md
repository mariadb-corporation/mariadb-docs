...
[MariaDB 10.8](what-is-mariadb-108.md) is a short-term maintenance stable series of MariaDB. It is an evolution of [MariaDB 10.7](../10.7/what-is-mariadb-107.md) with several entirely new features.
...
For a complete list of changes made in [MariaDB 10.8.3](10.8.3.md), with links to detailed information on each push, see the [changelog](../../changelogs/10.8/10.8.3.md).
