...
* [mariadb-backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup) locks database for minutes ([MDEV-28772](https://jira.mariadb.org/browse/MDEV-28772))
...
For a complete list of changes made in [MariaDB 10.10.2](10.10.2.md), with links to detailed information on each push, see the [changelog](../../changelogs/10.10/10.10.2.md).
