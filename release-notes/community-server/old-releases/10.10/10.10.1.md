...
[MariaDB 10.10](what-is-mariadb-1010.md) is a current short-term support development series of MariaDB. It is an evolution of [MariaDB 10.9](../10.9/what-is-mariadb-109.md) with several entirely new features.
...
For a complete list of changes made in [MariaDB 10.10.1](10.10.1.md), with links to detailed information on each push, see the [changelog](../../changelogs/10.10/10.10.1.md).
