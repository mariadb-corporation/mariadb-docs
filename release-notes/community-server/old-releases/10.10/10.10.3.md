...
[MariaDB 10.10](what-is-mariadb-1010.md) is a current short-term maintenance stable series of MariaDB, [maintained until](https://mariadb.org/about/#maintenance-policy) November 2023. It is an evolution of [MariaDB 10.9](../10.9/what-is-mariadb-109.md) with several entirely new features.
...
For a complete list of changes made in [MariaDB 10.10.3](10.10.3.md), with links to detailed information on each push, see the [changelog](../../changelogs/10.10/10.10.3.md).
