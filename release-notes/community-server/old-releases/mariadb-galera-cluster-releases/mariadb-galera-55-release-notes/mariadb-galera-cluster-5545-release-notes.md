...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.45)[Release Notes](mariadb-galera-cluster-5545-release-notes.md)[Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5545-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 18 Aug 2015

MariaDB Galera Cluster 5.5.45 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release.\
It is a merge of [MariaDB 5.5.45](../../5.5/5.5.45.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
For a list of changes made in MariaDB Galera Cluster 5.5.45, with links to detailed information on each push, see the [MariaDB Galera Cluster 5.5.45 Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5545-changelog.md).
