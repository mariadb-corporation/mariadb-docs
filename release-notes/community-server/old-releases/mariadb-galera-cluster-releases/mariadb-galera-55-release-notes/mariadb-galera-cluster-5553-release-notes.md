...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.53)[Release Notes](mariadb-galera-cluster-5553-release-notes.md)[Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5553-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 20 Oct 2016

MariaDB Galera Cluster 5.5.53 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release. It is a merge of [MariaDB 5.5.53](../../5.5/5.5.53.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
* The [Galera library](https://codership.com/content/using-galera-cluster) used by MariaDB Galera Cluster and included in the MariaDB repositories is currently at version 25.3.18.
