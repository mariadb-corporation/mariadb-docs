...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.48)[Release Notes](mariadb-galera-cluster-5548-release-notes.md)[Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5548-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 23 Feb 2016

MariaDB Galera Cluster 5.5.48 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release. It is a merge of [MariaDB 5.5.48](../../5.5/5.5.48.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
For a list of changes made in MariaDB Galera Cluster 5.5.48, with links to detailed information on each push, see the [MariaDB Galera Cluster 5.5.48 Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5548-changelog.md).
...
* The [Galera library](https://codership.com/content/using-galera-cluster) used by MariaDB Galera Cluster and included in the MariaDB repositories is currently at version 25.3.14.

### Deprecated Distributions

As per the [MariaDB Deprecation Policy](../../../about/platform-deprecation-policy.md), this will be the last release of MariaDB Galera Cluster 5.5 for Debian 6 "Squeeze".
