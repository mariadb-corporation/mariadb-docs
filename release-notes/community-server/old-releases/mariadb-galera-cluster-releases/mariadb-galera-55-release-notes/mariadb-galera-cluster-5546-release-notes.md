...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.46)[Release Notes](mariadb-galera-cluster-5546-release-notes.md)[Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5546-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 20 Oct 2015

MariaDB Galera Cluster 5.5.46 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release. It is a merge of [MariaDB 5.5.46](../../5.5/5.5.46.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
For a list of changes made in MariaDB Galera Cluster 5.5.46, with links to detailed information on each push, see the [MariaDB Galera Cluster 5.5.46 Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5546-changelog.md).
