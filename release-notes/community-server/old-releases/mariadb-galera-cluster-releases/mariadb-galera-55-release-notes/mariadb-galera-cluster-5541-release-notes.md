...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.41)[Release Notes](mariadb-galera-cluster-5541-release-notes.md)[Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5541-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 6 Jan 2015

MariaDB Galera Cluster 5.5.41 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release.\
It is a merge of [MariaDB 5.5.41](../../5.5/5.5.41.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
For a list of changes made in MariaDB Galera Cluster 5.5.41, with links to detailed information on each push, see the [MariaDB Galera Cluster 5.5.41 Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5541-changelog.md).

## Notes about this release

* MariaDB Galera Cluster 5.5.41 includes [MariaDB 5.5.41](../../5.5/5.5.41.md) with Codership additions (`lp:codership-mysql/5.5` till revision `4026`) and [Galera 25.3.5](https://codership.com/content/using-galera-cluster).
* This version of MariaDB Galera Cluster supports `wsrep` API v25 which means\
  MariaDB Galera Cluster can be used with either a 25.2.x or 25.3.x\
  Galera `wsrep` provider. A 25.3.x `wsrep` provider is included in the\
  MariaDB repositories and both 25.3.x and 25.2.x wsrep providers are available on the [downloads](https://downloads.mariadb.org/mariadb-galera/5.5.41) page.
