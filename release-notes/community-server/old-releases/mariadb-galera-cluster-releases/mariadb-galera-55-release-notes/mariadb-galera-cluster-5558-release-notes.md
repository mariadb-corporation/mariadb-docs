...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.58)[Release Notes](mariadb-galera-cluster-5558-release-notes.md)[Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5558-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 25 Oct 2017

MariaDB Galera Cluster 5.5.58 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release. It is a merge of [MariaDB 5.5.58](../../5.5/5.5.58.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
See the [MariaDB 5.5.58 Release Notes](../../5.5/5.5.58.md) for more information on fixes in this version.

## Changelog

A full list of all changes is in the [MariaDB Galera Cluster 5.5.58 Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5558-changelog.md) and the [MariaDB 5.5.58 Changelog](../../../changelogs/changelogs-mariadb-55-series/mariadb-5558-changelog.md).
