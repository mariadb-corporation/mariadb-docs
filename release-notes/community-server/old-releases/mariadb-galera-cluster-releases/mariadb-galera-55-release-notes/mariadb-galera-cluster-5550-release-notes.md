...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.50)[Release Notes](mariadb-galera-cluster-5550-release-notes.md)[Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5550-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 1 Jul 2016

MariaDB Galera Cluster 5.5.50 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release. It is a merge of [MariaDB 5.5.50](../../5.5/5.5.50.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
