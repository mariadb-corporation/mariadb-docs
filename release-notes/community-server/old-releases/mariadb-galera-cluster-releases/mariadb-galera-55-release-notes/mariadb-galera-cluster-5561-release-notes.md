...
MariaDB Galera Cluster 5.5.61 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release. It is a merge of [MariaDB 5.5.61](../../5.5/5.5.61.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
See the [MariaDB 5.5.61 Release Notes](../../5.5/5.5.61.md) for more information on fixes in this version.

## Changelog

A full list of all changes is in the [MariaDB Galera Cluster 5.5.61 Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5561-changelog.md) and the [MariaDB 5.5.61 Changelog](../../../changelogs/changelogs-mariadb-55-series/mariadb-5561-changelog.md).
