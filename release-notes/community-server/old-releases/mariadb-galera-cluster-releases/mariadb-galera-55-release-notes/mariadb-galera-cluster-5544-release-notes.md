...
It is a merge of [MariaDB 5.5.44](../../5.5/5.5.44.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
For a list of changes made in MariaDB Galera Cluster 5.5.44, with links to detailed information on each push, see the [MariaDB Galera Cluster 5.5.44 Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5544-changelog.md).
