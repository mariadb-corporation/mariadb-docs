...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.35) |[Release Notes](../mariadb-galera-55-release-notes/mariadb-galera-cluster-5535-release-notes.md) |**Changelog** |[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)
...
* [Revision #3464](https://bazaar.launchpad.net/~maria-captains/maria/maria-5.5-galera/revision/3464)\
  ...
  * Merged the missing revision 3934 from codership-mysql/5.5 (missed in the last merge).
...
* [Revision #3460](https://bazaar.launchpad.net/~maria-captains/maria/maria-5.5-galera/revision/3460)\
  ...
  * The bzr revision visible in [@@version\_comment](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#version_comment) should represent the last merged revision from codership branch and not the revision of the MGC tree itself.
