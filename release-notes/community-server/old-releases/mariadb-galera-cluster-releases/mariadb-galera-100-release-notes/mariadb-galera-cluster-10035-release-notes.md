...
[Download](https://downloads.mariadb.org/mariadb-galera/10.0.35)[Release Notes](mariadb-galera-cluster-10035-release-notes.md)[Changelog](../mariadb-galera-100-changelogs/mariadb-galera-cluster-10035-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 9 May 2018

MariaDB Galera Cluster 10.0.35 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release. It is a merge of [MariaDB 10.0.35](../../10.0/10.0.35.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
