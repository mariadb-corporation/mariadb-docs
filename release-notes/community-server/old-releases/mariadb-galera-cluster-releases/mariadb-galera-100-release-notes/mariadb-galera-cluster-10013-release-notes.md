...
[Download](https://downloads.mariadb.org/mariadb-galera/10.0.13)[Release Notes](mariadb-galera-cluster-10013-release-notes.md)[Changelog](../mariadb-galera-100-changelogs/mariadb-galera-cluster-10013-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 3 Sep 2014

This is the 5th release in the MariaDB Galera Cluster 10.0 series. It is a [_**Stable**_](../../../about/release-criteria.md) (GA) release. It is a merge of [MariaDB 10.0.13](../../10.0/10.0.13.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
For a list of changes made in MariaDB Galera Cluster 10.0.13, with links to detailed information on each push, see the [MariaDB Galera Cluster 10.0.13 Changelog](../mariadb-galera-100-changelogs/mariadb-galera-cluster-10013-changelog.md).
...
* [Snapshot state transfer](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/reference/galera-cluster-system-variables#wsrep_sst_method): rsync and mysqldump SST methods support [GTID](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/standard-replication/gtid). However, xtrabackup-v2 and xtrabackup SST methods currently do not support GTID.\
