...
[Download](https://downloads.mariadb.org/mariadb-galera/10.0.20)[Release Notes](mariadb-galera-cluster-10020-release-notes.md)[Changelog](../mariadb-galera-100-changelogs/mariadb-galera-cluster-10020-changelog.md)[Overview of MariaDB Galera Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide)

**Release date:** 27 Jun 2015

MariaDB Galera Cluster 10.0.20 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release. It is a merge of [MariaDB 10.0.20](../../10.0/10.0.20.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with additional bug fixes.
...
For a list of changes made in MariaDB Galera Cluster 10.0.20, with links to detailed information on each push, see the [MariaDB Galera Cluster 10.0.20 Changelog](../mariadb-galera-100-changelogs/mariadb-galera-cluster-10020-changelog.md).
