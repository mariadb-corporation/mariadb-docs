...
* BigEndian now builds in Cassandra storage engine ([MDEV-7839](https://jira.mariadb.org/browse/MDEV-7839)).
...
* Fixed assertion in Protocol::end\_statement where [CREATE VIEW](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/views/create-view) occurred after another connection aborted ([MDEV-8045](https://jira.mariadb.org/browse/MDEV-8045)).
