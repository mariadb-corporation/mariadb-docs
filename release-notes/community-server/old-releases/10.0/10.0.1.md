...
For a list of changes made in [MariaDB 10.0.1](10.0.1.md), with links to detailed information on each push, see the [Changelog](../../changelogs/) .
...
[Repository Configurator](https://downloads.mariadb.org/mariadb/repositories/) to generate the necessary commands to install MariaDB on these distributions.
