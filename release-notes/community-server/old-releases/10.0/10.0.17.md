...
* `[mysqlbinlog]({server}/clients-and-utilities/logging-tools/mariadb-binlog) --binlog-row-event-max-size` support added ([MDEV-6703](https://jira.mariadb.org/browse/MDEV-6703))
