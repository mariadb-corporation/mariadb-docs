...
* `--galera-sst-mode` option removed from mysqldump ([MDEV-7615](https://jira.mariadb.org/browse/MDEV-7615))
* `[mysqlbinlog](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/clients-and-utilities/logging-tools/mariadb-binlog) --binlog-row-event-max-size` support added ([MDEV-6703](https://jira.mariadb.org/browse/MDEV-6703))
