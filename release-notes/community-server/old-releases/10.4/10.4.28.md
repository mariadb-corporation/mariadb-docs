...
For a complete list of changes made in [MariaDB 10.4.28](10.4.28.md), with links to detailed information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-10-4-28-changelog.md).
