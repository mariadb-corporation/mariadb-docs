...
* Implementation of the [optimizer trace]({server}/ha-and-performance/optimization-and-tuning/query-optimizer/optimizer-trace), one can enable the optimizer trace by enabling the system variable [optimizer\_trace](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#optimizer_trace) ([MDEV-6111](https://jira.mariadb.org/browse/MDEV-6111))
