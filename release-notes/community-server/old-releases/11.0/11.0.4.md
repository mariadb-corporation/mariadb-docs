...
For a complete list of changes made in [MariaDB 11.0.4](11.0.4.md), with links to detailed information on each push, see the [changelog](../../changelogs/11.0/mariadb-11-0-4-changelog.md).
