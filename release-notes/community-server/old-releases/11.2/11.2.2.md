...
For a complete list of changes made in [MariaDB 11.2.2](11.2.2.md), with links to detailed information on each push, see the [changelog](../../changelogs/11.2/mariadb-11-2-2-changelog.md).
