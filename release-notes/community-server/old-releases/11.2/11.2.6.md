...
For a complete list of changes made in [MariaDB 11.2.6](11.2.6.md), with links to detailed information on each push, see the [changelog](../../changelogs/11.2/mariadb-11-2-6-changelog.md).
