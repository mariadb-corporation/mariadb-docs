...
For a complete list of changes made in [MariaDB 11.1.6](11.1.6.md), with links to detailed information on each push, see the [changelog](../../changelogs/11.1/mariadb-11-1-6-changelog.md).
