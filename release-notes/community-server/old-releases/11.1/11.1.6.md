...
* [Galera]({galera}) updated to 26.4.19
...
* [IMPORT TABLESPACE]({server}/reference/sql-statements/data-definition/alter/alter-table#import-tablespace) no longer unnecessarily traverses tablespaces list ([MDEV-34670](https://jira.mariadb.org/browse/MDEV-34670))
