...
* [Galera](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7/) updated to 25.3.35([galera 25.3.35 Release Notes](https://releases.galeracluster.com/galera-3.35/release-notes-galera-25.3.35.txt))
...
For a complete list of changes made in [MariaDB 10.3.33](10.3.33.md), with links to detailed information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10333-changelog.md).
