...
* [mariadb-backup --compress]({server}/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#-compress) hangs ([MDEV-29043](https://jira.mariadb.org/browse/MDEV-29043))
