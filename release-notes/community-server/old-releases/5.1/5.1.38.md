...
engine when configuring [MariaDB](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV).
...
The PBXT storage engine version 1.0.08d is
included in the source and binaries by default.
...
This is based on the microsec\_process
