...
Like [previous releases](../../README.md), [MariaDB 5.1.50](5.1.50.md) includes several bug fixes and other improvements. Specific bugs fixed in [MariaDB 5.1.50](5.1.50.md) include:
