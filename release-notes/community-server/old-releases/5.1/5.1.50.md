...
5.1.49. The MySQL [5.1.50](https://dev.mysql.com/doc/refman/5.1/en/news-5-1-50.html) release notes have details of what changes were made upstream by MySQL since 5.1.49.
...
Like [previous releases](../../), [MariaDB 5.1.50](5.1.50.md) includes several bug fixes and other improvements. Specific bugs fixed in [MariaDB 5.1.50](5.1.50.md) include:
