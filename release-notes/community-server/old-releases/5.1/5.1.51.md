...
Like [previous releases](../../README.md), [MariaDB 5.1.51](5.1.51.md) includes several bug fixes and other improvements. Specific bugs fixed in [MariaDB 5.1.51](5.1.51.md) include:
