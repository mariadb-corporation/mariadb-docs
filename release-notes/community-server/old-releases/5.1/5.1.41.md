...
[MariaDB](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/) 5.1.41 RC is based on [MySQL](https://www.mysql.com/) 5.1.41 and [XtraDB](https://www.percona.com/docs/wiki/percona-xtradb:start) 1.0.4-8.
...
We have included XtraDB 1.0.4-8 in this version of MariaDB. The [XtraDB 1.0.4-8 release notes](https://www.percona.com/docs/wiki/percona-xtradb:info:xtradb_changelog#release_1.0.4-8) have details of the changes made to XtraDB since version 1.0.3-6 (the version included with [MariaDB 5.1.38](5.1.38.md) Beta).
...
The tarball binaries provided in this release are generic binaries, intended for use on most x86-based Linux systems to quickly try out MariaDB without having to compile the source code. For 5.1.38 they were built on Ubuntu 9.04 systems (linked against libc 2.9), for 5.1.39 and 5.1.41 they were built on\
