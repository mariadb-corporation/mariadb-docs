...
5.1.54 and 5.1.55. The MySQL [5.1.54](https://dev.mysql.com/doc/refman/5.1/en/news-5-1-54.html) and [5.1.55](https://dev.mysql.com/doc/refman/5.1/en/news-5-1-55.html) release notes have details of what changes were made upstream by MySQL since 5.1.53.
...
Debian and Ubuntu repositories that we will keep up-to-date going forward. The new repositories make use of our world-wide network of MariaDB mirrors and will enable hassle-free upgrades to the latest version of MariaDB as soon as it is released.
...
Like [previous releases](../../../), [MariaDB 5.1.55](5.1.55.md) includes several bug fixes and other improvements. Specific bugs fixed in [MariaDB 5.1.55](5.1.55.md) include:
