...
5.1.52 and 5.1.53. The MySQL [5.1.52](https://dev.mysql.com/doc/refman/5.1/en/news-5-1-52.html) and [5.1.53](https://dev.mysql.com/doc/refman/5.1/en/news-5-1-53.html) release notes have details of what changes were made upstream by MySQL since 5.1.51.
...
Like [previous releases](../../), [MariaDB 5.1.53](5.1.53.md) includes several bug fixes and other improvements. Specific bugs fixed in [MariaDB 5.1.53](5.1.53.md) include:
