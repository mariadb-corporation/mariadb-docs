...
* [Galera](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7/) updated to 25.3.32
...
* [MDEV-23630](https://jira.mariadb.org/browse/MDEV-23630) - mysqldump --system option
...
For a complete list of changes made in [MariaDB 10.2.37](10.2.37.md) with links to detailed information on each push, see the [changelog](../../changelogs/changelogs-mariadb-102-series/mariadb-10237-changelog.md).
