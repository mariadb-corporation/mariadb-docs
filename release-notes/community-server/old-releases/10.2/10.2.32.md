...
* mysqldump parameter, `--ignore-table-data`, added ([MDEV-22037](https://jira.mariadb.org/browse/MDEV-22037))
* Server can fail while replicating conditional comments (Bug#28388217)
* [Galera wsrep library](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7/) updated to 25.3.29
...
For a complete list of changes made in [MariaDB 10.2.32](10.2.32.md) with links to detailed information on each push, see the [changelog](../../changelogs/changelogs-mariadb-102-series/mariadb-10232-changelog.md).
