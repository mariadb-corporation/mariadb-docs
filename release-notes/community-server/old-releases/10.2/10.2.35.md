...
* [Galera wsrep library](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7/) updated to 25.3.31
...
For a complete list of changes made in [MariaDB 10.2.35](10.2.35.md) with links to detailed information on each push, see the [changelog](../../changelogs/changelogs-mariadb-102-series/mariadb-10235-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.2.35](10.2.35.md), see the MariaDB Foundation release announcement.
