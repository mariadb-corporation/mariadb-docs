...
* [innodb\_safe\_truncate](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb/innodb-system-variables)
  ...
  * If you absolutely must use XtraBackup instead of [mariadb-backup](https://mariadb.com/docs/server/server-usage/backup-and-restore/mariadb-backup), you can set it to `OFF` and restart the server.
