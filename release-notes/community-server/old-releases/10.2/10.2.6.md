...
* [innodb\_deadlock\_detect]({server}/server-usage/storage-engines/innodb/innodb-system-variables#innodb_deadlock_detect) and [innodb\_stats\_include\_delete\_marked](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb/innodb-system-variables) variables introduced
