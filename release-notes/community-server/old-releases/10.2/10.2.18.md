...
* The [Galera library](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7/) in the repositories has been updated to version 25.3.24.
...
For a complete list of changes made in [MariaDB 10.2.18](10.2.18.md) with links to detailed information on each push, see the [changelog](../../changelogs/changelogs-mariadb-102-series/mariadb-10218-changelog.md).
