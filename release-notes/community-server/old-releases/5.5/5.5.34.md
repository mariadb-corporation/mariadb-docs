...
For a list of changes made in this release, with links to detailed information on each push, see the [MariaDB 5.5.34 Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5534-changelog.md).
...
* TokuDB 7.1.0
* mysql\_upgrade no longer sets the `write-binlog` option by default.
