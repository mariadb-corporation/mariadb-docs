...
For a list of changes made in [MariaDB 5.5.27](5.5.27.md), with links to detailed information on each push, see the [MariaDB 5.5.27 Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5527-changelog.md).
...
[MariaDB 5.5.27](5.5.27.md) includes [MariaDB 5.3.8](../5.3/5.3.8.md) and MySQL 5.5.27. See the [MariaDB 5.3.8](../5.3/5.3.8.md)[Release Notes](../5.3/5.3.8.md) and [Changelog](../../changelogs/changelogs-mariadb-53-series/mariadb-538-changelog.md) for more information on the changes in [MariaDB 5.3.8](../5.3/5.3.8.md). See [Changes in MySQL 5.5.27](https://dev.mysql.com/doc/refman/5.5/en/news-5-5-27.html) for what changed between this and previous MySQL versions.
