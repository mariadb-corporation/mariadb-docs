...
This is our first attempt at providing YUM repositories for MariaDB, so please [let us know](https://jira.mariadb.org/) if you run into
any issues.
...
systems. So please [let us know](https://jira.mariadb.org/) if you run into
any issues.
