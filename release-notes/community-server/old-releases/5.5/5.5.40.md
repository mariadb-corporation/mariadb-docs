...
For a list of changes made in this release, with links to detailed information on each push, see the [MariaDB 5.5.40 Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5540-changelog.md).
...
[MariaDB 5.5.40](5.5.40.md) is a maintenance release. It includes several bugfixes and updates, including from MySQL 5.5.40. Notable updates include:
