...
For a list of changes made in this release, with links to detailed information on each push, see the [MariaDB 5.5.44 Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5544-changelog.md).
...
[MariaDB 5.5.44](5.5.44.md) is a maintenance release. It includes several bugfixes and updates, including from MySQL 5.5.44. Notable updates include:
