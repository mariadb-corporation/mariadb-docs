...
For a list of changes made in this release, with links to detailed information on each push, see the [MariaDB 5.5.31 Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5531-changelog.md).
...
This release includes [MariaDB 5.3.12](../5.3/5.3.12.md) and MySQL 5.5.31. See [Changes in MySQL 5.5.31](https://dev.mysql.com/doc/relnotes/mysql/5.5/en/news-5-5-31.html) for what changed in MySQL.
...
* Support for FusionIO/directFS atomic writes added ([MDEV-4338](https://jira.mariadb.org/browse/MDEV-4338)). See the following for more information:
