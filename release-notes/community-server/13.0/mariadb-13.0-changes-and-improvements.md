...
* [`INFORMATON_SCHEMA.SYSTEM_VARIABLES`](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/information-schema/information-schema-tables/information-schema-system_variables-table) shows if a variable is deprecated ([MDEV-35369](https://jira.mariadb.org/browse/MDEV-35369))
* [`INFORMATON_SCHEMA.STATISTICS`](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/information-schema/information-schema-tables/information-schema-statistics-table) and [`INFORMATON_SCHEMA.COLUMNS`](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/information-schema/information-schema-tables/information-schema-columns-table) shows engine specific create options ([MDEV-36444](https://jira.mariadb.org/browse/MDEV-36444))
