...
[MariaDB 10.6](what-is-mariadb-106.md) is the current long-term maintenance stable series of MariaDB. It is an evolution of [MariaDB 10.5](../old-releases/10.5/what-is-mariadb-105.md) with several entirely new features.
...
For a complete list of changes and bugfixes made in [MariaDB 10.6.8](10.6.8.md), with links to detailed information on each push, see the [changelog](../changelogs/10.6/10.6.8.md).
