...
For a complete list of changes made in [MariaDB 10.6.19](10.6.19.md), with links to detailed information on each push, see the [changelog](../changelogs/10.6/10.6.19.md).
