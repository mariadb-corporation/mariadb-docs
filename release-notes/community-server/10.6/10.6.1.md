...
* DDL information logged on all [Galera]({galera}) cluster nodes if wsrep\_debug is set to SERVER and wsrep\_OSU\_method is 'TOI' ([MDEV-9609](https://jira.mariadb.org/browse/MDEV-9609))
