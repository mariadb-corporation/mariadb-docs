...
* [mariadb-backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup) skips valid .ibd file ([MDEV-26326](https://jira.mariadb.org/browse/MDEV-26326))
...
For a complete list of changes and bugfixes made in [MariaDB 10.6.6](10.6.6.md), with links to detailed information on each push, see the [changelog](../changelogs/10.6/10.6.6.md).
