...
For a complete list of changes and bugfixes made in [MariaDB 10.6.21](10.6.21.md), with links to detailed information on each push, see the [changelog](../changelogs/10.6/10.6.21.md).
