...
* [MariaDB 10.2](../../../old-releases/10.2/what-is-mariadb-102.md) does not support MySQL's `SELECT MAX_STATEMENT_TIME = N ...` syntax - see [Aborting Statements that Exceed a Certain Time to Execute]({server}/ha-and-performance/optimization-and-tuning/query-optimizations/aborting-statements).
