---
description: >-
  Release notes for MySQL-wsrep 8.4.9-26.27, the Q2 2026 LTS release of Galera
  Cluster for MySQL 8.4.
hidden: true
---

# MySQL-wsrep 8.4.9-26.27 Release Notes

## Changes in MySQL-wsrep 8.4.9-26.27 (2026-05-13)

MariaDB is pleased to announce a new LTS release of Galera Cluster for MySQL 8.4, consisting of MySQL-wsrep 8.4.9 and wsrep API version 26.

This release incorporates all changes up to MySQL 8.4.9.
...
### Notable changes and fixes in MySQL-wsrep in 8.4.9-26.27:
