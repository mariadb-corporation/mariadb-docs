---
description: >-
  Release notes for MySQL-wsrep 8.0.35-26.16, a release of Galera Cluster for
  MySQL 8.0.
---
...
* Foreign key constraint check retrying is implemented, as foreign key constraint checks may occasionally fail even though the constraints are not violated. The number of retries by default is 1, and can be controlled by the new system variable: wsrep-applier-FK-failure-retries.
