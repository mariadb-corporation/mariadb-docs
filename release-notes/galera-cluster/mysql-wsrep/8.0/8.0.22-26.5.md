---
description: >-
  Release notes for MySQL-wsrep 8.0.22-26.5, a release of Galera Cluster for
  MySQL 8.0.
---
...
* BF-BF conflicts between OPTIMIZE/REPAIR/ALTER TABLE and DML in presence of foreign key constraints were suppressed (MDEV-21577).
