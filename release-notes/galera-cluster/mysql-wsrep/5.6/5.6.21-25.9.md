---
description: >-
  Release notes for MySQL-wsrep 5.6.21-25.9, a release of Galera Cluster for
  MySQL 5.6.
---
...
* Automatic node eviction: unstable nodes can be removed from the cluster if they fail to consistently respond to heartbeat messages
