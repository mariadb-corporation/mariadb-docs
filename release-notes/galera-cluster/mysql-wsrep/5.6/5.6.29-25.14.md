---
description: >-
  Release notes for MySQL-wsrep 5.6.29-25.14, a release of Galera Cluster for
  MySQL 5.6.
---
...
* Wrong `auto_increment` values could be generated if Galera was a slave to an asynchronous master that is using STATEMENT replication (MW-248)
