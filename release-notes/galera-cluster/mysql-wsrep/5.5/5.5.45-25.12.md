---
description: >-
  Release notes for MySQL-wsrep 5.5.45-25.12, a release of Galera Cluster for
  MySQL 5.5.
---
...
* The SST password is no longer passed via the command line or visible in the error log or 'ps' output (codership/mysql-wsrep#141)
