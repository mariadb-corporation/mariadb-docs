---
description: >-
  Release notes for Galera 25.3.26, a release of the Galera Replication library.
---
...
* A check for duplicate node UUID was added to prevent node to join the cluster if another node with the same UUID already exists (codership/galera#533).
