...
If you are upgrading from an older major version of MaxScale, please read the [upgrading document](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-management/deployment/upgrading-maxscale#upgrading-mariadb-maxscale-from-23.02-to-23.08) for this MaxScale version.
...
* [MXS-4562](https://jira.mariadb.org/browse/MXS-4562) When MaxScalle is installed from tarball and started without -d option --basedir=. is not parsed properly and full directory needs to be specified
