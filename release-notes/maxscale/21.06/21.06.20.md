...
If you are upgrading from an older major version of MaxScale, please read the [upgrading document]({maxscale}/documentation-no-longer-available) for this MaxScale version.
...
There are some limitations and known issues within this version of MaxScale. For more information, please refer to the [Limitations]({maxscale}/documentation-no-longer-available) document.
