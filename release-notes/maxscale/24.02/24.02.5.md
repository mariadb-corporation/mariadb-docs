...
If you are upgrading from an older major version of MaxScale, please read the [upgrading document](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-management/deployment/upgrading-maxscale#upgrading-mariadb-maxscale-from-23.08-to-24.02) for this MaxScale version.
...
* [MXS-5340](https://jira.mariadb.org/browse/MXS-5340) ed25519 socket dropped when no user\_mapping\_file
...
For more information, please refer to the [Limitations](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-old-versions/mariadb-maxscale-24-02/maxscale-24-02about/mariadb-maxscale-2402-maxscale-2402-limitations-and-known-issues-within-mariadb-maxscale) document.
