...
If you are upgrading from an older major version of MaxScale, please read the [upgrading document](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-management/deployment/upgrading-maxscale#upgrading-mariadb-maxscale-from-21.06-to-22.08) for this MaxScale version.
...
For more information, please refer to the [Limitations](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/documentation-no-longer-available) document.
