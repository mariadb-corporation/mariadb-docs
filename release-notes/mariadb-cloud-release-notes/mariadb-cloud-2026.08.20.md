...
* Regions are enabled per account rather than from a fixed list. See the
  ...
  [MariaDB Cloud Region Choices](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/vPz15Lz0Iw3P3yKR3Prd/reference/region-choices).

For details, see [Bring Your Own Account (BYOA)](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/vPz15Lz0Iw3P3yKR3Prd/quickstart/bring-your-own-account-byoa).
...
For details, see [Launch Page](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/vPz15Lz0Iw3P3yKR3Prd/cloud-usage/launch-page).
