...
MariaDB Connector/Python 2.0.0 RC1 is a major rewrite that introduces significant improvements and new features while maintaining compatibility with the Python DB API 2.0 (PEP-249) standard.
...
MariaDB Connector/Python 2.0.0-rc1 can be obtained from the Python Package Index (PyPI):
...
For a list of changes made in this release, with links to detailed information on each push, see the [changelog](../changelogs/2.0/2.0.0-rc1.md).
