...
* commons-dbcp is now used only when testing, and there is no more need to import it. For more information, see the [About the MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j) page.
