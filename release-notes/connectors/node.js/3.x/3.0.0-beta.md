---
description: >-
  Connector/Node.js 3.0.0-beta is a Beta release of MariaDB Connector/Node.js,
...
* [connection.prepare(sql) → Promise](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/connector-nodejs-promise-api#connection.prepare-sql-promise): Prepares a query.
* [connection.execute(sql\[, values\]) → Promise](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/connector-nodejs-promise-api#connection.execute-sql-values-promise): Prepare and Executes a query.
