...
* [connection.prepare(sql) → Promise]({connectors}/mariadb-connector-nodejs/connector-nodejs-promise-api#connection.prepare-sql-promise): Prepares a query.
* [connection.execute(sql\[, values\]) → Promise]({connectors}/mariadb-connector-nodejs/connector-nodejs-promise-api#connection.execute-sql-values-promise): Prepare and Executes a query.
