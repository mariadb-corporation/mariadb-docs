---
description: >-
  Connector/Node.js 3.3.0 is a Stable (GA) release of MariaDB Connector/Node.js,
...
* Have server certificates generated with [trusted node.js Certificate Authorities (CA)](https://ccadb.my.salesforce-sites.com/mozilla/IncludedCACertificateReport), configuration was then like `ssl: true`.
