...
* [ODBC-480](https://jira.mariadb.org/browse/ODBC-480) - Incorect work of the SQLDescribeCol - it did not return column length if buffer parameter and buffer length were 0.
