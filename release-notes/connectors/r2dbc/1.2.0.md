...
* New timezone option ([R2DBC-93](https://jira.mariadb.org/browse/R2DBC-93))
  * The new timezone option can have 3 types of values:
    ...
    * `<a timezone>` : connector will set connection variable to the specified timezone; compared to auto, this avoids having some additional exchange with the server at connection creation
    * Examples:
