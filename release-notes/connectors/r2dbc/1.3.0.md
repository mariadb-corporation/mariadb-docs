...
* Support of the PARSEC Authentication Plugin, which is provided starting with MariaDB Server 11.6
  * See the [PARSEC Authentication Plugin documentation](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/plugins/authentication-plugins/authentication-plugin-parsec) for more details ([R2DBC-106](https://jira.mariadb.org/browse/R2DBC-106))
