...
* [CHECK TABLE]({server}/reference/sql-statements/table-statements/check-table) and [mariadb-check]({server}/clients-and-utilities/table-tools/mariadb-check) now support [SEQUENCE tables]({server}/server-usage/storage-engines/sequence-storage-engine), backported from MariaDB Community Server 12.0 ([MDEV-22491](https://jira.mariadb.org/browse/MDEV-22491))
